...
use App\Http\Middleware\doNotUserMakePayment;
...
class SubscriptionController extends Controller
{
    ...
    {
        $this->middleware(['auth', isEmployer::class, doNotUserMakePayment::class]);   
    }
    ...
    public function paymentSuccess(Request $request) {
        ...
        return redirect()->route('dashboard')->with('success', 'Wpłata zakończona pomyślnie');
    }

    public function cancel() {
        return redirect()->route('dashboard')->with('error', 'Wpłata nie zakończona pomyślnie');
    }
}
